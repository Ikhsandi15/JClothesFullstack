...
<body>
    <header class="header" id="header">
        <nav class="nav container primary-navigation">
            <a href="#" class="nav__logo "><img src="{{url('assets/img/logoBlackMode.png')}}" class="nav__logo">JCLothes</a>
    ...
    <div class="home__container container grid">
        <div class="Main">
            ...
            <div class="container__design">
                <img src="{{url('assets/design/img_design/img_product/' . $gambar)}}" alt="" style="margin-top: 45px;">
            </div>
    ...
    <div class="footer">
        ...
        <div class="image__of__currentProduct">
            <img src="{{url('assets/design/img_design/img_product/' . $gambar)}}" class="img__footer" alt="">
        </div>
